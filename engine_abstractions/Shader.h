...
namespace rtre {
    ...
    public:
        ...
        inline void SetUniform(const char *name, const Sphere &sphere)
        {
            ...
            glUniform3f(getUnifromID((uniName + "position").c_str()), sphere.position.x, sphere.position.y,
                        sphere.position.z);
        ...
        inline void SetUniform(const char *name, const Box &box)
        {
            ...
            glUniform3f(getUnifromID((uniName + "dimensions").c_str()), box.dimensions.x, box.dimensions.y,
                        box.dimensions.z);
